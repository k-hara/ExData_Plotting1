...
plot(hpc4$Date_Time, hpc4$Voltage, type = "l", xlab ="datetime", ylab = "Voltage")
plot(hpc4$Date_Time, hpc4$Global_reactive_power, type = "l", xlab ="datetime", ylab = "Global_reactive_power")
dev.off()
Sys.getlocale()